    ...
    try:
        ...
        if adx_value>0:
            if btcnum_list[-1]==0:
                ...
                elif ((psar_bear>0) and (vol<1.5) and (adx_value>25) and (len(recent_bear[recent_bear>0])<=6)):
                    btcnum_list.append(btcnum_list[-1])
                    cash_list.append(cash_list[-1])
                    fee_list.append(0)
                    pos_list.append(pos_list[-1])
