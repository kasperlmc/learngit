...
data_all_btc = pd.read_csv("/Users/wuyong/alldata/original_data/bitfinex_btcusdt_4h_all.csv", index_col=0)
data_all_ltc = pd.read_csv("/Users/wuyong/alldata/original_data/bitfinex_ltcusdt_4h_all.csv", index_col=0)
...
for coin in coin_list:
    data = pd.read_csv("/Users/wuyong/alldata/original_data/bitfinex_" + coin + "_4h_all.csv", index_col=0)
...
print(df_result_day)
df_result_day.to_csv("/Users/wuyong/alldata/original_data/bitfinex_btcusdt_4h_all_result.csv")
