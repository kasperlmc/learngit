...
# 获取上一根K线各个币对因子的排名
def get_rank(now_time, m=21, alpha="Alpha.alpha069"):
    ...
    for symbol in symbols:
        ...
        if len(df_temp) == 0:
            ...
            result_dict[symbol] = df_temp[alpha].dropna().values[0]
...
def multi_factor(cash, coin, coin_num, now_time, date, buyprice):
    ...
    if max_coin in ["ethbtc", "eosbtc", "xrpbtc", "trxbtc", "tusdbtc", "bchabcbtc", "bchsvbtc", "bnbbtc"]:
