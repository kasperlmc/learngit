    ...
    for i in range(len(alphas)):
        try:
            ...
            for param in params:
                ...
                stat, cols = summary(net_df, signal_df, param+"_negative"+'_all', 1)
                stat_ls.append(stat)
                ...
                stat, cols = summary(net_df, signal_df, param+"_positive"+'_all', 1)
                stat_ls.append(stat)
...
print(df_all)
df_all.to_csv('btcusdt_'+ "result_df_all" +'_stat.csv', float_format='%.4f')
